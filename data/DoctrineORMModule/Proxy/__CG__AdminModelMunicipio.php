 ...
 */
class Municipio extends \Admin\Model\Municipio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'criacao', 'modificacao', 'municipio', 'estado', 'primaryKeyField', 'tableName', 'inputFilter');
        }
    ...
    public function setMunicipio($valor)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMunicipio', array($valor));

        return parent::setMunicipio($valor);
    }

    /**
     * {@inheritDoc}
     */
    public function setEstado(\Admin\Model\Estado $valor)
    {
